(function(){
	...
	Ext.define('CommitMatrix', {
		...
		/****************************************************** App/SAFe Settings ************************************/		
		_prefName: 'intel-SAFe-apps-preference', //these settings are per user per project (like scoped release/page refresh rate)
		_safeConfigPrefName: 'intel-SAFe-apps-config', //these settings are the workspace config for trains/portfolio locations
