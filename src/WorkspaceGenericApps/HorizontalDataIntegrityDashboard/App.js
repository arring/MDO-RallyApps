...
(function(){
	...
	Ext.define('DataIntegrityDashboard', {
		...
		_getStories: function() {
			...
			me.UserStoryFetchFields = ['Name', 'ObjectID', 'Project', 'Owner', 'PlannedEndDate', 'ActualEndDate', 'StartDate', 'EndDate', 'Iteration[StartDate;EndDate]', 
		 ...
		 */
		_fixScheduleStateEditor: function() {
			var me = this;
