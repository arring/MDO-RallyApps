...
Ext.define('CustomApp', {
	...
	_loadPreferences: function(cb){ //parse all settings too
      ...
      filterByName:preferenceName+ uid,
			success: function(prefs) {
				var projs = prefs[preferenceName + uid];
				try{ projs = JSON.parse(projs); }
				catch(e){ projs = {}; }
				me.ProjPrefs = projs;
				console.log('loaded prefs', projs);
        cb();
			}
		});
	},
	...
	_getScopedRelease: function(){
		var me = this, d = new Date(), r,
			...
			prefOID = me.ProjPrefs[me.TrainRecord.get('ObjectID')];
		...
		me.ReleasePicker = me.add({
			...
			listeners: {
				select: function(combo, records){
					...
					me.ProjPrefs[me.TrainRecord.get('ObjectID')] = me.ReleaseRecord.get('ObjectID');
					me._savePreferences(me.ProjPrefs, function(){ me._reloadEverything(); });					
				}, 
